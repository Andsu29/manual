  ...
  <div class="vh">
    ...
    <div class="box">
      ...
      <p>
        ...
        <span style="color: green">Marca</span> -
        <span style="color: blue">Gênero(Linha)</span>
      </p>
      <h2>Exemplo - Feminino</h2>
      <p>
        <span style="color: orange">Calça Jeans </span>
        <span style="color: purple">Cigarrete </span>
      ...
      <p style="max-width: 90ch">
        ...
        trabalhar com o limite de 70 caracteres
      </p>
      <h2>Exemplo - Masculino</h2>
      <p>
        <span style="color: orange">Polo </span>
        <span style="color: purple">Manga Curta </span>
      ...
      <p>
        <span style="color: orange">Blusa </span>
        <span style="color: purple">Manga Curta </span>
